...
def save_outputs(all_files, out_text_path, out_json_path):
    ...
    with open(out_text_path, 'w', encoding='utf-8') as out:
        ...
        for f in all_files:
            ...
            if f.get('is_binary'):
                ...
                out.write("-" * 60 + "\n")
                out.write(f.get('content', '')[:100000])
...
def main():
    folders_to_scan = [
        '/home/parrot/Desktop/Film-Finance-App/apps/api/src',
        '/home/parrot/Desktop/Film-Finance-App/apps/web/app'
    ]
    ...
    output_folder = '/home/parrot/Desktop'
    os.makedirs(output_folder, exist_ok=True)

    out_text = os.path.join(output_folder, 'film_finance_files.txt')
    out_json = os.path.join(output_folder, 'film_finance_files.json')

    save_outputs(all_files, out_text, out_json)

    print("✅ File extraction completed.")
    print(f"📄 Text dump saved to: {out_text}")
