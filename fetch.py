...
def main():
    ...
    folders_to_scan = [
        '/home/parrot/Documents/Film-Finance-App/apps/api/src',   # API src only
        '/home/parrot/Documents/Film-Finance-App/apps/web/app'    # Web app only
    ]
    ...
    output_file = '/home/parrot/Documents/Film-Finance-App/allfiles.txt'
