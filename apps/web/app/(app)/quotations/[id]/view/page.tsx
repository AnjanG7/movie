...
export default function QuotationViewPage() {
  ...
  return (
    <div style={{ padding: '40px', maxWidth: '1200px', margin: '0 auto' }}>
      {/* Header */}
      <div style={{ marginBottom: '40px', borderBottom: '2px solid #4472C4', paddingBottom: '20px' }}>
        ...
        {quotation.summary?.totalsByPhase && (
          <div style={{ marginTop: '20px', marginBottom: '30px' }}>
            <table border={1} cellPadding={10} style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                {Object.entries(quotation.summary.totalsByPhase).map(([phase, amount]) => (
                  <tr key={phase}>
      ...
      {/* Summary */}
      {quotation.summary && (
        <div style={{ marginBottom: '40px', border: '2px solid #4472C4', padding: '20px', borderRadius: '8px' }}>
          ...
          <table style={{ width: '100%', fontSize: '14px' }}>
            <tbody>
              ...
              <tr style={{ fontSize: '18px', fontWeight: 'bold' }}>
                ...
                <td style={{ textAlign: 'right', padding: '15px 0 0 0', color: '#4472C4' }}>
...
{quotation.metrics?.irr != null && !isNaN(quotation.metrics.irr) ? `${Number(quotation.metrics.irr).toFixed(2)}%` : 'N/A'}
