...
export const createWaterfall = async (projectId: string) => {
  const response = await fetch(`${APIBASEURL}/projects/${projectId}/waterfalls`, {
    method: 'POST',
    credentials: 'include',
  });
...
export const addTiers = async (projectId: string, waterfallId: string, tiers: Omit<WaterfallTier, 'id' | 'waterfallId'>[]) => {
  const response = await fetch(`${APIBASEURL}/projects/${projectId}/waterfalls/${waterfallId}/tiers`, {
    method: 'POST',
...
export const addParticipants = async (projectId: string, waterfallId: string, participants: Omit<WaterfallParticipant, 'id' | 'waterfallId'>[]) => {
  const response = await fetch(`${APIBASEURL}/projects/${projectId}/waterfalls/${waterfallId}/participants`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    credentials: 'include',
...
// Add revenue period
export const addRevenuePeriod = async (projectId: string, waterfallId: string, period: Omit<WaterfallPeriod, 'id' | 'waterfallId'>) => {
  const response = await fetch(`${APIBASEURL}/projects/${projectId}/waterfalls/${waterfallId}/periods`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    credentials: 'include',
