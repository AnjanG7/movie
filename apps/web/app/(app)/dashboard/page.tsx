...
export default function DashboardPage() {
    ...
    const fetchUserCount = async () => {
      try {
        const res = await fetch(
          `https://movie-finance.onrender.com/api/auth/allUsers`,
          {
            method: "GET",
  ...
  useEffect(() => {
    const fetchActiveProjects = async () => {
      try {
        const res = await fetch(
          `https://movie-finance.onrender.com/api/projects/active`,
          {
            method: "GET",
            headers: { "Content-Type": "application/json" },
            credentials: "include",
  ...
  useEffect(() => {
    const fetchSummary = async () => {
      try {
        const res = await fetch(
          "https://movie-finance.onrender.com/api/projects/summary",
          {
            method: "GET",
            headers: { "Content-Type": "application/json" },
            credentials: "include",
  ...
  useEffect(() => {
    const fetchBudgetOverview = async () => {
      try {
        const res = await fetch(
          "https://movie-finance.onrender.com/api/dashboard/overview",
          {
            method: "GET",
            headers: { "Content-Type": "application/json" },
            credentials: "include",
  ...
  const fetchProjectStats = async () => {
    try {
      const response = await fetch(
        `https://movie-finance.onrender.com/api/dashboard/projectStats`,
        {
          method: "GET",
          headers: { "Content-Type": "application/json" },
          credentials: "include",
  ...
  const fetchUserStats = async () => {
    try {
      const response = await fetch(
        `https://movie-finance.onrender.com/api/dashboard/userStats`,
        {
          method: "GET",
          headers: { "Content-Type": "application/json" },
          credentials: "include",
  ...
  const fetchActiveProjectStats = async () => {
    try {
      const response = await fetch(
        `https://movie-finance.onrender.com/api/dashboard/activeProjectStats`,
        {
          method: "GET",
          headers: { "Content-Type": "application/json" },
          credentials: "include",
