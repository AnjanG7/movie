...
export default function AdminUsersPage() {
  ...
  const fetchUsers = async () => {
    try {
      const response = await fetch(`https://movie-finance.onrender.com/api/auth/allUsers`, {
        method: "GET",
  ...
  const handleDeleteUser = async (userId: string) => {
    try {
      const response = await fetch(
        `https://movie-finance.onrender.com/api/auth/delete/${userId}`,
        {
          method: "DELETE",
          credentials: "include",
        }
  ...
  const handleCreateUser = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://movie-finance.onrender.com/api/auth/add-user", {
        method: "POST",
        headers: {
              ...
              <form onSubmit={handleCreateUser} className="space-y-5">
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-medium"
                  >
                    {createLoading ? (
                      <>
