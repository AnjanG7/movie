...
export const createInvoice = asyncHandler(async (req, res) => {
    ...
    res
        ...
        .json(
            new ApiResponse(StatusCodes.CREATED, invoice, 'Invoice created successfully')
        );
});
...
export const updateInvoiceStatus = asyncHandler(async (req, res) => {
    ...
    res
        .status(StatusCodes.OK)
        .json(new ApiResponse(StatusCodes.OK, updated, 'Invoice status updated'));
});
...
export const deleteInvoice = asyncHandler(async (req, res) => {
    ...
    res
        .status(StatusCodes.OK)
        .json(new ApiResponse(StatusCodes.OK, result, 'Invoice deleted'));
});
